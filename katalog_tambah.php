        ...
        <div class="widget-content" >
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              $sql_tambah_masakan= mysqli_query($konek, $query_tambah_masakan);
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $sql_ubah_masakan = mysqli_query($konek, $query_ubah_masakan);
              ...
              if($gbr != "" || $gbr != null){
                ...
                $sql_ubah_gambar = mysqli_query($konek, $query_ubah_gambar);
              }
