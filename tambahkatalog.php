...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu'])){
    ...
    $query_data_edit = "select * from katalog where id_katalog = $id";
    $sql_data_edit = mysqli_query($konek, $query_data_edit);
    $result_data_edit = mysqli_fetch_array($sql_data_edit);

    $id_masakan = $result_data_edit['id_katalog'];
    $nama_masakan = $result_data_edit['nama_katalog'];
    $harga = $result_data_edit['harga'];
    $stok = $result_data_edit['stok'];
    $gambar_masakan = $result_data_edit['gambar'];
  }
